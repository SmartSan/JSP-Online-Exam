...
connect= DriverManager.getConnect(url,"","");

if(request.getParameter("action")!=null)
{
	SeatNum = request.getParameter("Seat_no"); /*Check this during execution for SeatNum*/
	...
	String query="INSERT INTO StudentTable (" + "Seat_no, Name, Marks" + ") VALUES (" +SeatNum +"","" +Name +"",""+ Total+"")";  /*needs to be checked*/
